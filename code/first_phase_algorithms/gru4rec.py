...
# Code for the GRU4Rec method by Balázs Hidasi
...
class GRU4Rec:
    ...
    def fit(self, data, retrain=False, sample_store=10000000, callback=None):
        ...
        X = T.ivector()
        Y = T.ivector()
        H_new, yPred, sampled_params = self.model(X, self.H, Y, self.dropout_p_hidden, self.dropout_p_embed)
        cost = self.loss_function(yPred)
